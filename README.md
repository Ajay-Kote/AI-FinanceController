...
- Role-based access: the first user is an administrator; later users are viewers
- Razorpay test-mode payments, refunds, and optional webhook processing
...
- Row Level Security limits financial records to their owner.
